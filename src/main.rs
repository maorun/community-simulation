...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let config = if let Some(preset_name) = &args.preset {
        ...
        SimulationConfig {
            ...
            black_market_price_multiplier: SimulationConfig::default().black_market_price_multiplier,
            black_market_participation_rate: SimulationConfig::default().black_market_participation_rate,
        }
    };
