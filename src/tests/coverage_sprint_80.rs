...
fn test_all_engine_getters_comprehensive() {
    let config = test_config().max_steps(100).entity_count(20).build();
...
fn test_get_current_result_incremental() {
    let config = test_config().max_steps(100).entity_count(15).build();
...
fn test_very_long_simulation() {
    let config = test_config().max_steps(1000).entity_count(40).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_large_population_simulation() {
    let config = test_config().max_steps(150).entity_count(200).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_simulation_with_many_steps_incremental() {
    let config = test_config().max_steps(500).entity_count(30).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_minimal_simulation() {
    let config = test_config().max_steps(10).entity_count(3).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_simulation_with_high_initial_money() {
    let config = test_config().max_steps(100).entity_count(25).initial_money(5000.0).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_simulation_with_low_initial_money() {
    let config = test_config().max_steps(100).entity_count(25).initial_money(10.0).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_simulation_with_high_base_price() {
    let config = test_config().max_steps(80).entity_count(20).base_price(200.0).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_result_print_summary_basic() {
    let config = test_config().max_steps(50).entity_count(15).build();
    let mut engine = SimulationEngine::new(config);
    let result = engine.run();
...
fn test_result_serialization() {
    let config = test_config().max_steps(40).entity_count(10).build();
    let mut engine = SimulationEngine::new(config);
    let result = engine.run();
...
fn test_result_deserialization() {
    let config = test_config().max_steps(30).entity_count(8).build();
    let mut engine = SimulationEngine::new(config);
    let result = engine.run();

    let json = serde_json::to_string(&result).unwrap();
    let deserialized: result::SimulationResult =
...
fn test_result_save_to_file() {
    let config = test_config().max_steps(50).entity_count(12).build();
    let mut engine = SimulationEngine::new(config);
    let result = engine.run();
...
fn test_result_components_formatting() {
    let config = test_config().max_steps(40).entity_count(12).build();
    let mut engine = SimulationEngine::new(config);
    let result = engine.run();
...
fn test_seasonal_factor_calculation() {
    let config = test_config().max_steps(50).entity_count(15).seasonality(0.5, 50).build();
    let engine = SimulationEngine::new(config);
...
fn test_seasonal_simulation() {
    let config = test_config().max_steps(200).entity_count(20).seasonality(0.3, 40).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_run_with_progress_enabled() {
    let config = test_config().max_steps(100).entity_count(30).build();
...
fn test_simulation_with_transaction_fee() {
    let config = test_config().max_steps(100).entity_count(25).transaction_fee(0.05).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_simulation_with_savings() {
    let config = test_config().max_steps(100).entity_count(25).savings_rate(0.1).build();
    let mut engine = SimulationEngine::new(config);
...
fn test_simulation_with_multiple_skills_per_person() {
    let config = test_config().max_steps(80).entity_count(20).skills_per_person(3).build();
    let mut engine = SimulationEngine::new(config);
